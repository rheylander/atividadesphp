...
echo "<br><br>";
    ...
    echo "A temperatura está $Fahrenheit °F";
...
echo "<br><br>";
    ...
    echo "Empréstimo Bancário: $valordoemprestimo";
    /*pula uma linha*/ echo "<br>";  
    echo "Valor da parcela: $ValorDaParcela" ;
    /*pula uma linha*/ echo "<br>";
    echo "Valor Total: $valorTotaldoEmprestimo";
